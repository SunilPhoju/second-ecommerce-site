...
function userRegister(){
    ...
    var isError='';
    if(name==""){
        jQuery('#nameError').html('enter the name');   
        isError='yes';     
    }if(email==""){
        jQuery('#emailError').html('enter the email');   
        isError='yes';     
    }if(mobile==""){
        jQuery('#mobileError').html('enter the mobile');   
        isError='yes';     
    }if(password==""){
        jQuery('#passwordError').html('enter the password');   
        isError='yes';     
    }
    if(isError==''){
        jQuery.ajax({
            ...
            success:function(result){
                if(result=='emailPresent'){
                    jQuery('#emailError').html('This email has already been used');
                }
                if(result=='insert'){
                    jQuery('.registerMessage p').html('You have been registered Succesfully');
                }
            }
        });
    }    
...
function userLogin(){
    ...
    var isError='';
    if(email==""){
        jQuery('#loginEmailError').html('enter the email');   
        isError='yes';     
    }if(password==""){
        jQuery('#loginPasswordError').html('enter the password');   
        isError='yes';     
    }
    if(isError==''){
        jQuery.ajax({
            ...
            success:function(result){
                if(result=='wrong'){
                    jQuery('.loginMessage p').html('Make sure you have entered correct login details');
                }
                if(result=='valid'){
...
function manageCart(pid,type,qty){
    if(type=='update'){
